    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="pesan.php">pesan</a></li>
          <li><a class="getstarted scrollto" href="tentang.php">Mulai</a></li>
        </ul>
  ...
  <main id="main">
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Budaya</h2>
          <p>Akan menyenangkan jika anda mempelajari Budaya yang ada di Kutai Barat</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Budaya</a></li>
